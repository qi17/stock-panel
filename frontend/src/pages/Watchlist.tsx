...
import { fmtPrice, fmtPct, fmtBigNum, priceColorClass, getExtNumColorClass, formatExtNumber } from '@/lib/format'
...
function renderExtValue(
  ...
  if (typeof val === 'number') {
    ...
    const displayVal = hasNumFmt
      ...
      : (Math.abs(val) >= 10000 ? fmtBigNum(val) : (Number.isInteger(val) ? fmtPrice(val, 0) : fmtPrice(val)))
